...
public class ReusableMethods {
	...
	public static void verifyTitle(String ecspectedTitle) throws InterruptedException {
		...
		if (driver.getTitle().contains(ecspectedTitle)) {
			System.out.println(
					"Pass:  Expected title - '" + ecspectedTitle + "' is equal to Actual text - '" + actualTitle + "'");
			logger.log(LogStatus.PASS,
					"Actual title - '" + actualTitle + "' is equal to Expected title - '" + ecspectedTitle + "'");
		} else {
			System.out.println("False: Actual title - '" + actualTitle + "' is not equal to Expected title - '"
					+ ecspectedTitle + "'");
			logger.log(LogStatus.FAIL,
					" Actual Text - '" + actualTitle + "' is not equal to Expected title - '" + ecspectedTitle + "'");
		}
	}
